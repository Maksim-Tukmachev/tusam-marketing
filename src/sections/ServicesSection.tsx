...
export function ServicesSection() {
  ...
  return (
    <section 
      ref={containerRef} 
      id="services"
      className="relative z-20 px-[5px] pb-[5px] bg-white scroll-mt-[72px]"
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-10 gap-y-8 mb-10 sm:mb-16 md:mb-20 items-start">
            ...
            <div className="lg:col-span-7 max-w-xl">
              <p className="text-base sm:text-xl md:text-2xl font-medium tracking-tight text-white/70 leading-relaxed">
                <span className="text-white">Диагностика → Стратегия → Внедрение → Сопровождение.</span> Каждый этап опирается на данные и научную методологию.
              </p>
            </div>
          </div>
