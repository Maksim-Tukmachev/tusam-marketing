...
const items = [
  {
    ...
    desc: "Диагностику проводит Кандидат наук. Разбираем процессы, финансы и управление.",
    label: "Экспертность",
  },
  {
    title: "Честная оценка",
    desc: "Если точек роста нет, скажем прямо. Не берём проект ради проекта.",
    label: "Без обязательств",
  },
  {
    title: "Полная конфиденциальность",
    desc: "Подписываем NDA до обмена любыми данными о вашем бизнесе.",
    label: "NDA",
  },
];
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 sm:mb-16 md:mb-20 gap-6 sm:gap-8">
          <div className="max-w-4xl">
            <div className="reveal-text">
              ...
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold tracking-[-0.06em] text-black leading-[0.85]">
                ...
                <span className="text-[#747474]">системный рост?</span>
              </h1>
            </div>
          </div>
          ...
          <div className="reveal-text">
             <p className="text-base sm:text-xl md:text-2xl font-medium tracking-tight text-[#747474] max-w-sm">
               Оставьте контакты — свяжемся и согласуем удобное время для экспресс-диагностики.
             </p>
          </div>
        </div>
