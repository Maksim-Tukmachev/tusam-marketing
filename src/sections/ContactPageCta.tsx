...
const steps = [
  { num: "01", title: "Согласуем время", text: "Свяжемся, уточним задачу и назначим удобное время сессии." },
  { num: "02", title: "Экспресс-диагностика", text: "Онлайн-сессия 1,5 часа: разбираем процессы и точки роста." },
  { num: "03", title: "Честный вывод", text: "Если точек роста нет — скажем прямо. Никаких лишних расходов." },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-5">
            ...
            <p className="text-sm font-medium text-[#747474]">
              Свяжемся и согласуем удобное время. Без скриптов — живой разговор с экспертом.
            </p>
            <div className="mt-8">
