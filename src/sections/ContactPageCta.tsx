...
const steps = [
  { num: "01", title: "Звонок за 5 минут", text: "Перезвоним и разберёмся в задаче. Без скриптов." },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-5">
            ...
            <p className="text-sm font-medium text-[#747474]">
              Перезваниваем в течение 5 минут. Без менеджеров-роботов — живой разговор.
            </p>
            <div className="mt-8">
