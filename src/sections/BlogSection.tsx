  ...
  return (
    <section ref={containerRef} className="relative z-20 px-4 md:px-9 py-16 sm:py-24 md:py-32 bg-white">
      <div className="max-w-[1520px] mx-auto">
        <div className="blog-header mb-10 sm:mb-16 md:mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          ...
          <div className="flex flex-col items-start md:items-end gap-6">
            <p className="text-lg md:text-xl font-medium tracking-tight text-[#747474] max-w-sm md:text-right">
              Без воды и громких обещаний. Прикладные материалы о стратегии, финансах и управлении.
            </p>
            ...
            {BLOG_POSTS.slice(0, 3).map((post) => (
              ...
              >
                ...
                <div className="flex-1 py-6 px-4 sm:px-6 flex flex-col justify-center relative">
                  ...
                  <div className="mt-6 flex items-center gap-2 text-black/20 group-hover:text-[#1C5E3C] transition-colors duration-500">
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <div className="relative z-10 flex justify-between items-start w-full">
                <span className="text-base sm:text-lg font-bold tracking-[-0.03em] text-white">
                  Асыльяр
                </span>
              ...
              <div className="relative z-10 w-full flex flex-col items-end text-right mt-auto pt-20">
                ...
                <div className="w-16 h-16 rounded-full bg-[#1C5E3C] text-black flex items-center justify-center group-hover:scale-110 group-hover:bg-white transition-all duration-500 ease-out">
