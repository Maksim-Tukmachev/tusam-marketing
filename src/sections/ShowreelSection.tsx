...
export function ShowreelSection() {
  ...
  return (
    <section ref={containerRef} id="process" className="relative z-20 px-4 md:px-9 py-16 sm:py-24 md:py-32 bg-white scroll-mt-[72px]">
      <div className="max-w-[1520px] mx-auto">
        <div className="process-header mb-16 md:mb-24">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-8xl font-bold tracking-[-0.05em] text-black mt-8">
            От диагностики<br />
            <span className="text-[#747474]">до готовой системы.</span>
          </h2>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mt-10">
            <p className="text-xl md:text-2xl font-medium tracking-tight text-[#747474] max-w-xl">
              Прозрачный процесс с понятными этапами. <span className="text-black">Вы видите логику каждого шага.</span>
            </p>
            <ButtonPill href="#contact" variant="black">Начать с экспресс-диагностики</ButtonPill>
          </div>
        </div>
