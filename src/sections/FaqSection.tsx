...
export function FaqSection() {
  ...
  return (
    <section
      ...
      aria-label="Часто задаваемые вопросы о бизнес-консалтинге и разработке стратегии"
    >
      <script
