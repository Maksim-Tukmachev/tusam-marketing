...
import { NAV_LINKS, CONTACT_EMAIL, CONTACT_PHONE, CONTACT_PHONE_HREF } from "@/lib/constants";
        ...
        <div className="mx-auto w-full px-4 md:px-9">
          <nav className="flex items-center justify-between py-4">
            <TransitionLink href="/" label="Главная" className="shrink-0 z-[60]">
              <span className="text-base md:text-lg font-bold tracking-[-0.03em] text-[#090909] whitespace-nowrap">
                Асыльяр
                <span className="text-[#747474] font-medium hidden sm:inline"> Бизнес-консалтинг</span>
              </span>
            </TransitionLink>
          ...
          >
            ...
            >
              <div className="flex flex-col items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-[#747474] text-sm font-medium">Позвоните нам</span>
                  <a
