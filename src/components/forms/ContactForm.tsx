  ...
  if (submitState === "success") {
    return (
      <div className="bg-white rounded-[18px] p-6 text-center">
        ...
        <p className="text-base text-[#0a0a0a]/60">Свяжемся и согласуем удобное время</p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold tracking-[-0.04em] text-[#0a0a0a]/80">
        Оставьте контакты — <span className="text-[#0a0a0a]/60">свяжемся и согласуем время.</span>
      </h2>
      ...
      >
        {submitState === "loading" ? "Отправка…" : "Записаться на диагностику"}
      </button>
    </form>
  );
}
