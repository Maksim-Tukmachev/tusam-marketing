...
export const metadata: Metadata = {
  ...
  description:
    "Стратегический консалтинг для малого и среднего бизнеса. Разработка бизнес-стратегии, оцифровка процессов и вывод собственника из операционки по научной методологии Доктора наук.",
  ...
  openGraph: {
    ...
    description:
      "Диагностика → Стратегия → Внедрение → Сопровождение. Научная методология Доктора наук и практический опыт управления. Измеримый финансовый результат.",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Стратегический консалтинг для МСБ по научной методологии Доктора наук. Диагностика, стратегия, внедрение, сопровождение.",
    images: [
      {
        url: `${SITE_URL}/og-image.png`,
        width: 1200,
